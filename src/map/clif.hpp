...
{// clif_skill_fail
	...
	USESKILL_FAIL_GC_WEAPONBLOCK_ON = 97,
	USESKILL_FAIL_OVER_INSTALLATION = 98,
	USESKILL_FAIL_FAIL_SPELLBOOK_NONE = 99,
	...
	USESKILL_FAIL_CALLHOMUN_INVALID_JOBTYPE = 112,
	USESKILL_FAIL_CALLHOMUN_OVER_100LEVEL = 113,
	USESKILL_FAIL_STRIPSHADOW_TO_MADO_NOTICE = 114,
	USESKILL_FAIL_MAX
};
